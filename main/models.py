...
class Service(models.Model):
    category = models.ForeignKey(ServiceCategory, on_delete=models.CASCADE, related_name='service', null=True)
...
class Invitation(models.Model):
    ...
    totalClicks = models.IntegerField(null=True, default=0)
